...
const handler = async (event) => {
    ...
    try {
        ...
        if (property.userId !== userId && userRole !== 'Admin_User') {
            return createErrorResponse(403, 'FORBIDDEN', 'You do not have permission to upload documents to this property');
        }
        ...
        return createErrorResponse(500, 'INTERNAL_ERROR', 'An error occurred while generating the upload URL. Please try again.');
    }
};
